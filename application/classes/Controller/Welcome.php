...
class Controller_Welcome extends Controller_Template {
	...
	public function before() {
		...
		$this->_session = Session::instance();
		/*		
		$log->add(Log::DEBUG,'================USER===============>: '.$user->username);
		$log->add(Log::DEBUG,'================SESSION===============>: '.serialize($this->_session->id()));
		$log->add(Log::DEBUG,'================COOKIES===============>: '.serialize($_COOKIE['session']));
		foreach ($_SERVER as $key=>$val) {
			$log->add(Log::DEBUG,'================SERVER===============>'.$key.': '.$val);
		}*/
