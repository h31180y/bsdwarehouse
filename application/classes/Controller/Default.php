...
*/
	...
	public function action_login() {
		...
		if($this->request->method()===HTTP_Request::POST) {
			...
			if(ORM::factory('User')->where('username', '=', $this->request->post('username'))->find()->status == 'Aktywny') {
				...
				Message::error(ucfirst(__('Twoje konto zostało zablokowane lub usunięte')), '/default/login');
			}
		}
	}
