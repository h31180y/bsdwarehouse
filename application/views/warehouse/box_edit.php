				...
				<div id="tab_1-1" class="tab-pane active">
					...
					<div class="form-group">
						...
						<div class="input-icon">
							...
							<input id="seal" class="form-control" type="text" name="place" value="<?php echo sprintf('%012d',$box->place->barcode);?>">
						</div>
						<span class="help-block"></span>
					</div>
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="description"><?php echo $box->description; ?></textarea>
						<span class="help-block"></span>
					</div>
					...
					<div class="form-group">
						...
						<div class="input-icon">
							<i class="fa fa-lock fa-fw"></i>
							<input id="barcode" class="form-control" type="text" name="barcode" placeholder="" value="<?php echo sprintf('%012d',$box->barcode);?>">
						</div>
					</div>
