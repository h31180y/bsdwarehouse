							...
							<td class="wrapper vertical-middle">
								...
								<tr>
									<td class="vertical-middle">
										<a href="index.html">
										<img src="<?php echo ASSETS_ADMIN_LAYOUT_IMG; ?>logo.png" width="86" height="14" border="0" alt=""/>
										</a>
									</td>
								</tr>
								</table>
								...
								<tr>
									<td>
										...
										<tr>
											<td class="vertical-middle">
												<a href="#">
												<img src="<?php echo ASSETS_ADMIN_PAGES_MEDIA; ?>email/social_facebook.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="<?php echo ASSETS_ADMIN_PAGES_MEDIA; ?>email/social_twitter.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="<?php echo ASSETS_ADMIN_PAGES_MEDIA; ?>email/social_googleplus.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="<?php echo ASSETS_ADMIN_PAGES_MEDIA; ?>email/social_linkedin.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="<?php echo ASSETS_ADMIN_PAGES_MEDIA; ?>email/social_rss.png" alt="social icon"/>
												</a>
											</td>
										</tr>
										</table>
					...
					<td class="wrapper last">
						...
						<tr>
							<td>
								...
								<img src="<?php echo ASSETS_ADMIN_PAGES_MEDIA; ?>email/article.png" class="ie10-responsive" alt=""/>
							</td>
							<td class="expander">
							</td>
						</tr>
					...
					<td>
						...
						<tr>
							<td class="wrapper last">
								...
								<i>Ta wiadomość została wygenerowana automatycznie, prosimy na nią nie odpowiadać.</i>
								</span>
							</td>
						</tr>
						</table>
