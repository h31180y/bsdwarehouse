					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab4">
							...
							<div class="order_type_3" style="display: none;" >
								...
								<div class="form-group">
									<label class="control-label col-md-3">Uwagi:</label>
									<div class="col-md-4">
										<p class="form-control-static" data-display="order_description_3">
										</p>
									</div>
								</div>
							...
							<div class="order_type_4" style="display: none;" >
								...
								<div class="form-group">
									<label class="control-label col-md-3">Uwagi:</label>
									<div class="col-md-4">
										<p class="form-control-static" data-display="order_description_4">
										</p>
									</div>
								</div>
							...
							<div class="order_type_6" style="display: none;" >
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<p class="form-control-static" data-display="order_description_6">
										</p>
									</div>
								</div>
