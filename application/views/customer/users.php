					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td class="center">
									 <?php if($user->status == 'Zablokowany'):?>
									 	<span class="badge badge-warning center" ><?php echo $user->status;?> </span>
									 <?php elseif($user->status == 'Usunięty'): ?>
									 	<span class="badge badge-danger center" ><?php echo $user->status;?> </span>
									 <?php else:?>
									 	<span class="badge badge-primary center" ><?php echo $user->status;?> </span>
									 <?php endif;?>
								</td>
								<td>
									<div class="margin-bottom-5">
											<?php if($user->status != 'Usunięty'):?>
											...
											<?php elseif($user->status == 'Zablokowany'):?>
											...
											<?php endif;?>	
											<?php if($user->status != 'Usunięty'):?>
												<button class="btn btn-xs red customer-user-delete margin-bottom" id="<?php echo $user->id ;?>"><i class="fa fa-recycle"></i> Usuń</button>
											<?php endif;?>
									</div>
								</td>
							</tr>
