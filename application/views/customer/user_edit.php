<div class="row profile-account">	
	...
	<div class="col-md-9">
		<form role="form" action="/customer/user_edit/<?php echo $user->id?>" method="POST" id="add_user_form">
			...
			<div class="tab-content">
				...
				<div id="tab_1-1" class="tab-pane active">
					...
					<div class="form-group">
						<label class="control-label" for="divisions">Działy
							<span class="required" aria-required="true"> * </span>
						</label>
						<select multiple class="form-control" name="divisions[]" id="divisions">
					...
					<div class="form-group">
						<label class="control-label" for="roles">Rola
							<span class="required" aria-required="true"> * </span>
						</label>
						<div class="input-icon right">
